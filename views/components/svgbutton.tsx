...
export function SVGButton(props: SVGButtonProps) {
  return (
    <a target="_blank" href={props.tgturl} className={tw`${props.bgcolor}rounded-md font-bold text-white text-center px-4 py-3 transition duration-300 ease-in-out hover:bg-red-600 ml-2`}>
